...
# These are just display names - the API still uses agnes-2.0-flash
TEXT_MODEL_DISPLAY = "agnes-2.0-flash"
IMAGE_MODEL_DISPLAY = "agnes-image-2.1-flash"  
VIDEO_MODEL_DISPLAY = "agnes-video-v2.0"
